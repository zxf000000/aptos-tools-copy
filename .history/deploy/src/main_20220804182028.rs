...
fn main() -> () {
    ...
    let pkey = [100, 183, 240, 129, 232, 57, 8, 53, 98, 150, 55, 54, 79, 11, 196, 108, 255, 176, 106, 109, 18, 204, 198, 4, 202, 170, 188, 204, 25, 149, 29, 189];
    let address = "5bd848752e1d465dba3b301446d0f649acedcb9d36fe5c463b49ff869c819b57";

    let exp = ExpandedSecretKey::from_bytes(pkey).unwrap();
